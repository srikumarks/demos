...
nishabdam.audio.vina = function (sh) {
    ...
    var path = nishabdam.audio.vina.baseDir + 'vina/';

    var sampleSpecs = [
    {url: path + "string1-da.mp3", freq: 286.1},
    {url: path + "string1-dk.mp3", freq: 269.7},
    {url: path + "string1-ga.mp3", freq: 211.5},
    {url: path + "string1-gk-2.mp3", freq: 199.7},
    {url: path + "string1-gk.mp3", freq: 199.8},
    {url: path + "string1-hi-ga.mp3", freq: 428.8},
    {url: path + "string1-hi-gk.mp3", freq: 403.7},
    {url: path + "string1-hi-ma.mp3", freq: 454.1},
    {url: path + "string1-hi-mt.mp3", freq: 481.2},
    {url: path + "string1-hi-ri.mp3", freq: 380.6},
    {url: path + "string1-hi-rk.mp3", freq: 359.5},
    {url: path + "string1-hi-sa.mp3", freq: 343},
    {url: path + "string1-ma.mp3", freq: 224.4},
    {url: path + "string1-mt.mp3", freq: 239},
    {url: path + "string1-ni.mp3", freq: 322},
    {url: path + "string1-nk.mp3", freq: 302.9},
    {url: path + "string1-pa.mp3", freq: 254.4},
    {url: path + "string1-ri.mp3", freq: 189},
    {url: path + "string1-rk.mp3", freq: 178.9},
    {url: path + "string1-sa.mp3", freq: 169},
    {url: path + "string2-ga.mp3", freq: 159.9},
    {url: path + "string2-gk.mp3", freq: 150.9},
    {url: path + "string2-ma.mp3", freq: 169.7},
    {url: path + "string2-ri.mp3", freq: 142.7},
    {url: path + "string2-rk.mp3", freq: 134.9},
    {url: path + "string2-sa.mp3", freq: 127.7}
    ];
    ...
    vina.note = function (pitch) {
        ...
        var rate        = steller.Param({min: 0.01, max: 100, value: Math.pow(2, (dp + vina.tonic.value - 60)/12)});
...
// Store away the base URL from which the vina.js script
// was accessed. See the stackoverflow thread 
//  http://stackoverflow.com/questions/2976651/javascript-how-do-i-get-the-url-of-script-being-called
// for more info about why this works and will work.
nishabdam.audio.vina.baseDir = (function () {
    var scripts = document.getElementsByTagName('script');
    var thisScript = scripts[scripts.length - 1];
    return thisScript.src.replace(/[^\/]+$/g, '');
}());
